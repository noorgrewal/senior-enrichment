    ...
    render() {
        ...
        return (
            ...
            <div className="col-md-12">
                <div>
                    <Link to="/students/new"><button type="button" className="btn btn-primary add">+</button></Link>
                </div>
                            ...
                            students.map(students => {
                                return (
                                    <tr key={students.id}>
                                        ...
                                        <td className="text-right"><button type="button" onClick={this.handleClick} id={students.id} className="btn btn-xs btn-danger" >X</button></td>
                                    </tr>
                                );
                            })
                        }
